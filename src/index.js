...
function renderAdminHtml() {
  const mobileTableStyle = `<style>@media(max-width:720px){.relay-panel .table,.relay-panel .table tbody,.relay-panel .table tr,.relay-panel .table td{display:block;width:100%}.relay-panel .table thead{display:none}.relay-panel .table tr{padding:12px 0;border-bottom:1px solid #28445f}.relay-panel .table td{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;padding:7px 0;border:0;text-align:right;overflow-wrap:anywhere}.relay-panel .table td::before{color:#8fa5bc;font-size:12px;font-weight:700;text-align:left;content:attr(data-label)}.relay-panel .table td:nth-child(1)::before{content:'地址'}.relay-panel .table td:nth-child(2)::before{content:'状态'}.relay-panel .table td:nth-child(3)::before{content:'延迟'}.relay-panel .table td:nth-child(4)::before{content:'连接时长'}.relay-panel .table td:nth-child(5)::before{content:'转发'}.relay-panel .table td:nth-child(6)::before{content:'下载'}.relay-panel .table td:nth-child(7)::before{content:'上传'}.relay-panel .table td:nth-child(8)::before{content:'下载量'}.relay-panel .table td:nth-child(9)::before{content:'重连'}.relay-panel .table td:nth-child(10)::before{content:'最后错误'}.relay-panel .table td:nth-child(11)::before{content:'操作'}}</style>`;
