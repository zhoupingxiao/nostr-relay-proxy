...
function renderAdminHtml() {
  ...
  return ADMIN_HTML
    ...
    .replace("td.textContent=v;if(i===1)td.className", "td.textContent=v;if(i===0){const handle=document.createElement('span');handle.className='drag-handle';handle.textContent='⠿';handle.title='拖动排序';td.prepend(handle)}if(i===1)td.className")
