...
function renderAdminHtml() {
  ...
  return ADMIN_HTML
    ...
    .replace('</body>', `${activeUsersScript}${activeUsersNamesScript}${accessUsersFormScript}${namedAccessSettingsScript}${relayOrderScript}${safeAdminRefreshScript}${adminVisibilityScript}${localizationScript()}</body>`);
}
