...
const UI_TRANSLATIONS = {
  zh: {
    ...
    effectiveUsers: "有效用户", onlineUsers: "在线用户", clientSubscriptions: "客户端活跃订阅", upstreamSubscriptions: "上游活跃订阅",
  ...
  en: {
    ...
    effectiveUsers: "Effective users", onlineUsers: "Online users", clientSubscriptions: "Client active subscriptions", upstreamSubscriptions: "Upstream active subscriptions",
...
const UI_STATIC_KEYS = {
  "管理后台": "admin", "查看前台": "viewHome", "退出": "logout", "复制连接地址": "copyUrl", "正在获取网络状态…": "loading", "一个更可靠的": "homeTitle1", " Nostr 连接入口。": "homeTitle2", "聚合多个上游 Relay，为你的客户端提供统一、稳定的 WebSocket 连接。上游 Relay 列表会按后台设定的安全间隔自动更新，兼顾状态及时性与 Cloudflare 免费额度。": "homeDescription",
